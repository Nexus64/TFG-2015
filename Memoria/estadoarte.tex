...
El sector de la realidad virtual facturó en el año 2016 un total de \textbf{2.700 millones de dolares}, 1.100 millones menos de lo previsto según las estimaciones iniciales, mientras que la realidad aumentada generó un total de 1.200 millones de dólares, gracias en gran parte al éxito de \citegame{pokemon_go}. Pese a este lento inicio, las previsiones de crecimiento siguen siendo positivas, alcanzando los 108.000 millones de dólares en el año 2021, como se puede ver en la figura \ref{crecimiento-vr} \cite{libro_blanco}.
...
\begin{figure}[h]
    ...
    \caption{Shigeru Miyamoto (creador de \citegame{super_mario_bros}, \citegame{legend_of_zelda} y \citegame{donkey_kong}) es posiblemente el diseñador de videjouegos más famoso.}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Jonh Romero es el co-fundador de ID Software y programador de juegos como \citegame{doom} o \citegame{quake}.}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Akira Toriyama, el autor de Dragon Ball, ha trabajado como artista en juegos como \citegame{dragon_quest} o \citegame{chrono_trigger}.}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Yoko Shinomura es una compositora conocida por su trabajo en videojuegos como \citegame{final_fantasy_15} o \citegame{street_fighters_2}.}
\end{figure}
...
\begin{figure}[h]
	...
	\centering
	\caption{\citegame{pacman_256}, disponible para PC, Android, IOS, PS4 y XBOX One}
	\label{pacman-256}
\end{figure}
